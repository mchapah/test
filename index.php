...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Coders <span class="lite">Crew</span></a>
      <!--logo end-->
              ...
              <li><i class="fa fa-laptop"></i>Dashboard</li>
                        ...
                        case 'add_chapter':
                           include('add_chapter.php');
                            break;
                        case 'agenthouses':
                           include('agenthouses.php');
                            break;
                         case 'landlordsmanagement':
                           include('landlordsmanagement.php');
                            break;
                        case 'projects':
                           include('contributions.php');
                            break;
                        case 'teacherclassallocation':
                      include('teacherclassallocation.php');
                            break;
                        case 'allprojects':
